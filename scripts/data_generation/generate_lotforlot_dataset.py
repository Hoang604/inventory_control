"""
Generate Lot-for-Lot Policy Dataset

Uses optimal parameters from grid search: d=[44,20,1]
"""
import os
...
# Optimal configs from grid search (profit: 350.83)
CONFIGS = [
    [44, 20, 1],
    [46, 20, 1],
    [47, 21, 1],
...
def generate_dataset(num_warehouses: int, days_per_warehouse: int, save_path: str) -> None:
    print(f"Generating Lot-for-Lot Dataset")
    ...
    for warehouse_id in tqdm.tqdm(range(num_warehouses), desc="Warehouses"):
        ...
        policy = LotForLotPolicyPerStage(env, config)
...
if __name__ == "__main__":
    ...
    save_path = str(PROJECT_ROOT / "data" / "inv_management_lotforlot.pt")
